 ...
 */
public class ApplicationHome extends BaseDAO {
	...
	public Application findById(long id) {
		...
		try {
			Application instance = (Application) sessionFactory.getCurrentSession().get("Application", id);
			if (instance == null) {
	...
	public List findByExample(Application instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession().createCriteria("Application")
