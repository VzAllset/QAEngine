...
public class CaptureAttrActionProcessor implements ActionExecutor{
	...
	public CaptureAttrActionProcessor(QaObject object, QaData data, WebDriver driver, QaStep step, QaFlow flow)
	{
		this.object = object;
		this.driver = driver;
		this.flow = flow;
	...
	public void runAction() {
		...
		String capturedValue =  Utils.getWebElement(driver, xpath).getAttribute(flowStepMapExample.getRefKey());
